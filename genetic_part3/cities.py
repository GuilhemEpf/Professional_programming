...
filename="C:/Users/guilh/OneDrive/Bureau/A4/Professional Programming/TP3/Professional_programming/genetic_part3/cities.txt"
...
def road_length_middle(cities:Dict[str, Coordinates], road:Iterable[str]) -> float:
    """ Calculate the length of the road """
    road_coords = [cities[c] for c in road]
    total = 0
    for i in range(len(road_coords)-1-len(road)//2):
...
if __name__ == '__main__':
    city_dict = load_cities("C:/Users/guilh/OneDrive/Bureau/A4/Professional Programming/TP3/Professional_programming/genetic_part2/cities.txt")
    print(city_dict)
